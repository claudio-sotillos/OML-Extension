...
EXTENSION_NAME=OML_READER
EXTENSION_FLAGS=\
-DDUCKDB_EXTENSION_NAMES="oml_reader" \
...
#### Main build
# For regular CLI build, we link the oml_reader extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/oml_reader/oml_reader.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/oml_reader/oml_reader.duckdb_extension'
